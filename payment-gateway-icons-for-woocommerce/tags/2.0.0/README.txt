...
1. Download and Upload `Payment_Gateway_Icon_For_WooCommerce folder to the `/wp-content/plugins/` directory.
1. You may also search in WordPress dashboard directly and install.
1. Activate the plugin through the 'Plugins' menu in WordPress.
1. Go to *WooCommerce* &rarr; *Settings* &rarr; *Payments* &rarr; select the payment gateway you want change its icon &rarr; below the settings of every payment method, you'll see additional settings added below by this plugin. Enter an image URL to the *Icon* field.
1. There is provision for two sizes, mobile and desktop. Format your icons to your desired size before uploading as plugin does not utter size. 

== Screenshots ==

1. This is how the icons appear on checkout
2. This is plugin's logo
